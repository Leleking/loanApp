                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td><a href="" user="{{$user->id}}"  class="trigger"><button class="btn btn-dark btn-rounded "><i class="fa fa-edit"></i></button></a>
                                               ...
                                               <a href=""><button class="btn btn-warning btn-rounded ">@if($user->status) <i class="fa fa-remove"></i> @else <i class="fa fa-check"></i> @endif</button></a>
                                            </td>
                                        </tr> 
                                    @endforeach
...
<div id="modal"data-iziModal-fullscreen="true" hidden data-iziModal-title="Pay EMI"  data-iziModal-subtitle="Please be sure to get all the right data before making a payment"  data-iziModal-icon="icon-credit-card" >
        <div class="">
                <div class="card-body">
                        {!!Form::open(['action'=>'makePaymentController@store','method'=>'POST', 'name'=>'userdata'])!!}
                            <div class="form-body">
                                <h3 class="card-title m-t-15">User Detail <img id="loader" src="/img/loader.gif" alt=""></h3>
                                <hr>
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">User Account ID</label>
                                            <input type="text" readonly  name="name"   class="form-control"  name="surname">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input name="email" type="text" readonly id="name" class="form-control form-control-danger" >
                                         </div>
                                    </div>
                                    <!--/span-->
                                </div>
                                <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly name="status" id="name" class="form-control"  name="surname">
                                                </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
