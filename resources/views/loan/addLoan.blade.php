                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="radio" name="emi_type" checked value="1" class="" >Reducing Balance
                                                  </div>
                                                </div>
                                                <div class="col-md-5">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="radio" name="ad_emi" id="name" checked value="0" class="" >No
                                                      </div>
                                                </div>
                                                <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label">Payment Mode</label><br>
                                                            <input type="radio" name="pay_mode" checked value="1" id="name" class="" >Cheque <br>
