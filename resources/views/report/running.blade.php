                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                     @if($loan['status'] && $payment && !$payment['status'])
                                    <tr>
                                           ...
                                           <?php $user =App\User::find($customers->user_id);?>
                                           <td>{{$user->name}}</td>

                                            <td>@if(!$user->isAdmin)Staff @elseif($user->isAdmin == 1)Admin @else Super Admin @endif</td>
                                            <td><a href="/customer/{{$customers->id}}/edit"><button class="btn btn-dark btn-rounded "><i class="fa fa-edit"></i></button></a>
                                                <a href="/invoice/running/{{$customers->id}}"><button class="btn btn-danger btn-rounded "><i class="fa fa-bar-chart"></i></button></a>
